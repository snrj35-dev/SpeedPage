...
<div class="user-panel">
    ...
    <div class="mb-4 d-flex flex-wrap justify-content-between align-items-center gap-2">
        <button class="btn btn-success px-4 rounded-pill shadow-sm" id="addUserBtn">
            <i class="fa fa-plus me-1"></i> <span lang="add_user">Kullanıcı Ekle</span>
        </button>
        
        <div class="input-group" style="max-width: 300px;">
            <span class="input-group-text bg-white border-end-0"><i class="fas fa-search text-muted"></i></span>
            <input type="text" id="userListSearch" class="form-control border-start-0 ps-0" placeholder="<?= e(__('search_market')) ?>" lang="search_market">
        </div>
    </div>

    <div id="usersTableWrap" class="card border-0 shadow-sm rounded-4 overflow-hidden mb-3">
