...
<div class="page-panel">
    <div class="d-flex justify-content-between mb-3">
        ...
        <div>
            <button class="btn btn-primary me-2" type="button" data-bs-toggle="collapse" data-bs-target="#newSection">
                <i class="fas fa-plus"></i> <span lang="newpage"></span>
            </button>
            <button class="btn btn-success" type="button" data-bs-toggle="collapse" data-bs-target="#newMenuSection">
            ...
            <button class="btn btn-warning text-white" type="button" data-bs-toggle="modal"
                ...
                <i class="fas fa-code"></i> <span lang="snippet_management">Snippet Yönetimi</span>
            </button>
        </div>
    </div>
                    ...
                    <?php foreach ($pages as $p): ?>
                        <tr>
                            ...
                            <td class="text-end" style="padding-right: 20px;">
                                <button class="btn btn-action btn-outline-primary edit-btn" data-slug="<?= e($p['slug']) ?>"
