...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-12 d-md-none p-2">
            <button class="btn btn-dark w-100 mb-2" type="button" data-bs-toggle="collapse"
        ...
        <div class="col-12 col-md-9 p-4 db-content">
            ...
            <form id="uploadSqlForm" enctype="multipart/form-data" onsubmit="return uploadSqlFile(this)">
                ...
                <div class="input-group mb-2">
                    ...
                    <button class="btn btn-warning btn-sm" type="submit"><i class="fa fa-upload"></i> <span
                            lang="upload_backup_button"></span></button>
                </div>
            </form>
