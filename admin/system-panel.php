                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end" data-label="<?= e(__('details')) ?>">
                                            <div class="d-flex justify-content-end gap-1">
                                                <?php if (($log['action_type'] ?? '') === 'system_error' || ($log['action_type'] ?? '') === 'db_error'): ?>
                                                    <a href="index.php?page=aipanel&bug=<?= urlencode($log['message']) ?>" 
                                                       class="btn btn-sm btn-outline-primary" title="AI ile Çöz">
